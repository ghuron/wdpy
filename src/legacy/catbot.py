...
for prop in ['P131', 'P17', 'P569', 'P840', 'P59', 'P881', 'P6087', 'P571', 'P53', 'P39', 'P19', 'P20', 'P176',
    ...
    # 'P2962', 'P97', 'P171', 'P405', 'P141', 'P1344', 'P403'
    ...
    for offset in range(0, int(count), 10):
        ...
        for row in my_list:
            blacklist = ['Q706268', 'Q4740163', 'Q19008', 'Q273809', 'Q317149', 'Q181900', 'Q1030348', 'Q90465',
                         ...
                         'Q3117649', 'Q3180990', 'Q4730963', 'Q167545', 'Q570982', 'Q145746', 'Q9203192', 'Q2425979']
